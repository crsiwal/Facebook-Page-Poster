...
<script type="text/javascript">
  ...
  jQuery(".label_select_all_all input").change(function() {
    var a = jQuery(this).prop("checked")
    jQuery(".group_label input").prop("checked", a);
  })
  jQuery(".rkmsonly input").change(function() {
    var a = jQuery(this).prop("checked")
    jQuery(".group_label:contains('Rkms'), .group_label:contains('RKMS')").find('input').prop("checked", a);
  })
